...
public:
    ...
    void showTranslation(const string& word) {
        ...
        if (result) {
            result->access_count++;
            cout << "ѕереклад слова '" << word << "': " << result->translation << endl;
        }
        else {
            cout << "—лово '" << word << "' не знайдено." << endl;
        }
    }
    ...
    void replaceTranslation(const string& word, const string& newTranslation) {
        ...
        if (result) {
            ...
            cout << "ѕереклад слова '" << word << "' було зам≥нено." << endl;
        }
        else {
            cout << "—лово '" << word << "' не знайдено." << endl;
        }
    ...
    void deleteWord(const string& word) {
        ...
        cout << "—лово '" << word << "' було видалено." << endl;
    }
    ...
    void showTop3Popular() {
        ...
        cout << "“оп-3 найпопул€рн≥ших сл≥в:" << endl;
    ...
    void showTop3Unpopular() {
        ...
        cout << "“оп-3 найменш попул€рних сл≥в:" << endl;
        for (int i = 0; i < 3 && i < nodes.size(); i++) {
            cout << nodes[i]->word << " (" << nodes[i]->access_count << " звернень)" << endl;
        }
    }
